...
export class PlayerDetailPage implements OnInit {
  ...
  constructor(
    ...
    this.player_id = this.ActivatedRoute.snapshot.paramMap.get('_id');
  ...
  upcomingMatches(){
    this.apiservice.post('playerUpMatches',{_id: this.player_id},'').subscribe((result) => { 
...
err => {
   ...
   previousMatches(){
    this.apiservice.post('mypreviousMatches',{_id: this.player_id},'').subscribe((result) => {  
...
err => {
   ...
   getHoursOfPlay(){
    this.apiservice.post('getHoursOfPlay',{_id: this.player_id},'').subscribe((result) => { 
      this.response1_came=true;           
     var res;
     res = result;
...
err => {
   ...
   getPlayerInfo(){
    this.apiservice.post('playerAllInfo',{_id: this.player_id},'').subscribe((result) => {  
      var res;
      res= result;
